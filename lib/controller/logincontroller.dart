  ...
  async {
    ...
    try {
      ...
      navigatorKey.currentState!.popUntil(
          ((route) => route //el currentstate devuelve el context actual creo
              .isFirst)); //regresa hasta la primera ruta que es el main, y el main muestra home al estar loggeado el usuario
      //esto nos permite eliminar el indicador de carga que se lanza en el login

    } on FirebaseAuthException catch (e) {
      String error =
          " "; //está variable se usará para capturar el texto de la excepción y mostrarsela al usuario

      if (e.code == 'user-not-found') {
        print('No user found for that email.');
        error =
            "Usuario no encontrado, si desea registrarse pulse sobre el botón Registrarse";
