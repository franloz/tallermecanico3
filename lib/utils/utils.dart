...
class Utils{
  ...
  void dialogCircularProgress(BuildContext context){
    showDialog(//se muestra un cuadro de dialogo con un símbolo de carga
      context: context, 
      barrierDismissible: false,//false para que al clicar sobre el dialog no tenga efecto
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: const Text('Ok'),                                           //esto nos permite eliminar el indicador de carga que se lanza en el login
            ),
          ],
        ));
  }
  ...
  void dialogSignUp(BuildContext context, String error){
    showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () {Navigator.of(context).pop();Navigator.of(context).pop();}, //regresa hasta la primera ruta que es el main, y el main muestra home al estar loggeado el usuario                                                    
              child: const Text('Ok'),                                           //esto nos permite eliminar el indicador de carga que se lanza en el login
            ),
          ],
        ));
