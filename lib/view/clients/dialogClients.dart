                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              if (dnitxt.text.isEmpty ||nombretxt.text.isEmpty ||telftxt.text.isEmpty ||direcciontxt.text.isEmpty) {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              if (dni.text.isEmpty ||name.text.isEmpty ||tlf.text.isEmpty ||direction.text.isEmpty) {
